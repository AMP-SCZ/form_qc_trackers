...
class CalcQCer:
    def __init__(self):
        ...
        calculation_config = self.config_info.get("calculation_qc", {})
        ...
        self.all_data_path = calculation_config.get(
            "raw_extract_path", os.path.join(self.depend_path, "all_recalcs_combined.csv"))
        self.all_data_df = pd.read_csv(
        self.all_data_path,
        keep_default_na = False)
        self.recalc_path = calculation_config.get(
            "discrepancies_path", os.path.join(self.depend_path, "rule_h_like_discrepancies.csv"))
    ...
    def _write_revised_output(self):
        ...
        output_df.to_csv(
        f'{self.output_path}diffs_test_revised_new_module.csv',
        index = False)
