...
class PharmChecks(FormCheck):
    ...
    COMBINATION_MED_CODES = frozenset({146, 280}) # adderall/400 removeds
        ...
        for chrap_var, pharm_codes in self._chrap_to_pharm_codes.items():
            ...
            if chrap_says_yes and not matching_codes:
                self._append_qc(
                    ...
                    forms,
                    [chrap_var],
                    f"{chrap_var} is coded as 1 (lifetime antipsychotic use) on lifetime_ap_exposure_screen, "
                    f"but no matching course is recorded in past_pharmaceutical_treatment "
                ...
                self._append_qc(
                    ...
                    f"{chrap_var} is coded as {chrap_val} (not 1 / not lifetime use), but "
                    f"past_pharmaceutical_treatment records a matching antipsychotic course "
