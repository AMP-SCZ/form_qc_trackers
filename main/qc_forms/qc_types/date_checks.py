...
class DateChecks(FormCheck):
    ...
    Flags route to a dedicated "Date Report" tab in both networks' combined,
    site, and Melbourne RA workbooks. Date findings are not mirrored onto
    Main Report; their reviewer state is reconciled through Date Report.
    """
